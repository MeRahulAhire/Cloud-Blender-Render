...
# Blender CLI
RUN wget https://download.blender.org/release/Blender5.2/blender-5.2.0-linux-x64.tar.xz && \
    mkdir /app/blender && \
    tar xf blender-5.2.0-linux-x64.tar.xz -C /app/blender --strip-components 1 && \
    rm blender-5.2.0-linux-x64.tar.xz
