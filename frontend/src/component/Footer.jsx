      ...
      <div className="footer-glass-holder">
        ...
        <div className="footer-end-contact">
            <div className="footer-email">
                Email us at <a href="mailto:info@rahulahire.com">info@rahulahire.com</a>
            </div>
            <div className="footer-github">
                Project is fully open source on <a href="https://github.com/MeRahulAhire/Cloud-Blender-Render" target="_blank" rel="noopener noreferrer">GitHub</a>
            </div>
        </div>
      </div>
